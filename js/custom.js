...
$(function() {
    ...
    $('form#supportForm').on('submit', function(e) {
        ...
        $.post('save-form.php', sendArray, function(data) {
            ...
            var supportButton = '$("body").append(\'<div id="support-button" class="bootstrap-styles" style="position: fixed;right: 0px;bottom: 100px; z-index:10000;"><a data-toggle="modal" href="#sp-modal"  class="btn btn-primary btn-lg">'+parsed['form-action']+'</a></div>\');';
